"""
CSV exporter — converts a list of dicts (from either crawler) into a .csv file.

Design notes:
- utf-8-sig encoding so Excel opens the file correctly without manual BOM dance.
